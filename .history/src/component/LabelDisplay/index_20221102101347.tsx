...
export default function LabelDisplay() {
    ...
    const drawGraph = ()=>{
            ...
            let Rscale = d3.scaleLinear().range([500,svgWidth]).domain([0,annotate.current.iHeight*annotate.current.iWidth])
            ...
            if (layoutType == 0 || layoutType == 2) {
                ...
                for (let i = 0; i < entityContext.array.length; i++) {
                    ...
                    if (element.visAble) {
                        if (layoutType == 0) {
                            element.x = (svgWidth*50) * (element.lx - element.ix) / (element.iScale * element.iWidth)
                            element.y = (svgHeight*50) * (element.ly - element.iy) / (element.iScale * element.iHeight)
                        }
