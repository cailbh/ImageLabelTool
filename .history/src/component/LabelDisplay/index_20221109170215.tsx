...
export default function LabelDisplay() {
    ...
    const drawGraph = ()=>{
        ...
        let Rscale = d3.scaleLinear().range([svgWidth/20,svgWidth/10]).domain([0,annotate.current.iHeight*annotate.current.iWidth])
