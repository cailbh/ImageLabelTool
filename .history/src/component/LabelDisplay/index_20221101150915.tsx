                ...
                <div className="canvasMain">
                    ...
                    <div id="sideBar" className="toolFeatures">
                        ...
                        <div className="baseInformation">
                            ...
                            <div className="info infoSize">尺&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;寸：<div className="infoDiv">{task.current.size}</div></div>
                            <div className="info infoDescribe">简&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述：<div className="infoDiv">{task.current.describe}</div></div>
