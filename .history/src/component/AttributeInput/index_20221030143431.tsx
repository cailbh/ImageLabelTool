    ...
    nameInput = (data) => {
        return (
            <div className='attrValue'>
                <input autoComplete="off" type="text" className="valueInput" value={data} onChange={(e) => this.nameChange(e, "name")} />
            </div>
        )
    }
    attrInput = (data) => {
                            ...
                            return (
                                <div className="attrInput" >
                                    <div className="attrKey">
                                        <input type="text" className={"keyInput attr" + index} value={item.attrKey} onChange={(e) => this.attrChange(e, index, "attrKey")} />
                                    </div>
                                    <div className='attrValue'>
                                        <input type="text" className={"valueInput attr" + index} value={item.attrValue} onChange={(e) => this.attrChange(e, index, "attrValue")} />
                                    </div>
