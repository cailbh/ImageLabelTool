    ...
    nameInput = (data: string) => {
        return (
            <div className='attrValue'>
                <input autoComplete="off" type="text" className="valueInput" placeholder={data} value={this.state.name} onChange={(e) => this.nameChange(e, "name")} />
            </div>
        )
    }
    attrInput = (data: any[]) => {
                            ...
                            return (
                                <div className="attrInput" >
                                    <div className="attrKey">
                                        <input type="text" className={"keyInput attr" + index}  placeholder={item.attrKey} value={item.attrKey} onChange={(e) => this.attrChange(e, index, "attrKey")} />
                                    </div>
                                    <div className='attrValue'>
                                        <input type="text" className={"valueInput attr" + index} placeholder={item.attrValue} value={item.attrValue} onChange={(e) => this.attrChange(e, index, "attrValue")} />
                                    </div>
