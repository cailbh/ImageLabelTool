        ...
        return (
            data.map((item, index) => {
                ...
                target = entityContext.array.find((d) => { return d.id == item.targetId })
                    ...
                    //                         return <input type="text" className = "smallInput" value={'root'} />
                    //                     }
                    //                     let source = entityContext.array.find((d) => { return d.id == rowData.sourceId })
            
                    //                     return <input type="text" className = "smallInput" value={source.name} onChange={(e) => nameChange(e, rowData.id, "source")} />
                    //                     // return <p>{source.name} </p>
                return (
                    <Row className="align-items-center">
                        <Col xs="auto" className="relRow relHead">
                            <input type="text" className = "smallInput" value={source.name} onChange={(e) => nameChange(e, item.id, "source")} />
                        </Col>
                        <Col xs="auto" className="relRow relType">
                        <input type="text" id="smallInput_name" className = "smallInput" value={item.name} onChange={(e) => nameChange(e, item.id, "name")} />
                        </Col>
                        <Col xs="auto" className="relRow relTail">
                            <input type="text" className = "smallInput" value={target.name} onChange={(e) => nameChange(e,item.id, "target")} />
                        </Col>
                        <Col xs="auto" className="relRow relTail">
                            <input type="text" className = "smallInput" value={item.color} onChange={(e) => nameChange(e,item.id, "color")} />
                        </Col>
...
<div id="relationship-table">
    ...
    <Form>
      {rowData(dataList.current)}
        ...
        //             <Cell>
        //                 {(rowData, rowIndex) => {
        //                     return <input type="text" className = "smallInput" value={rowData.name} onChange={(e) => nameChange(e, rowData.id, "name")} />
        //                 }}
        //             </Cell>
        //         </Column>
        //         <Column width={70} resizable>
        ...
        //                     return <input type="text" className = "smallInput" value={target.name} onChange={(e) => nameChange(e, rowData.id, "target")} />
        //                 }}
        //             </Cell>
        //         </Column>
        //         <Column width={70} resizable>
        ...
        //             <Cell>
        //                 {(rowData, rowIndex) => {
        //                     return <input type="text" className = "smallInput" value={rowData.color} onChange={(e) => nameChange(e, rowData.id, "color")} />
        //                 }}
        //             </Cell>
        //         </Column>
