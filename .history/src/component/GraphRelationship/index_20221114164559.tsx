            ...
            data.map((item, index) => {
                ...
                return (
                    <div className="relRowR">
                        ...
                        <input type="text" id="smallInput_name" className = "smallInput" placeholder={item.name} onClick={(e) => nameClick(e, item.id)} onChange={(e) => nameChange(e, item.id, "name")} />
                        </div>
                        ...
                        <div  className="relRow relTail">
                            <input type="text" className = "smallInput" placeholder={item.type} onChange={(e) => nameChange(e,item.id, "type")} />
                        </div>
